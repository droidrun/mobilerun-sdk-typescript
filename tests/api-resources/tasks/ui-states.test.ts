...
describe('resource uiStates', () => {
  ...
  test.skip('retrieve: only required params', async () => {
    const responsePromise = client.tasks.uiStates.retrieve(0, { task_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.tasks.uiStates.retrieve(0, { task_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });
  });
