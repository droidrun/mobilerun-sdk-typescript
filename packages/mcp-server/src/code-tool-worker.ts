...
const fuse = new Fuse(
  [
    ...
    'client.devices.trafficSessions.create',
    'client.devices.trafficSessions.delete',
    'client.devices.trafficSessions.list',
    'client.devices.trafficSessions.retrieve',
    'client.models.list',
    ...
    'client.workflows.flows.capacity',
