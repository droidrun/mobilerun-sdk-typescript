...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['packageName', 'credentialName', 'fields'],
  },
  annotations: {},
};
...
export const handler = async (client: Mobilerun, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.credentials.packages.credentials.create(packageName, body)),
    );
  } catch (error) {
