...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/tasks/{task_id}/gif',
  operationId: 'get_task_gif_tasks__task_id__gif_get',
};
...
export const handler = async (client: DroidrunCloud, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.tasks.getGif(task_id)));
};
