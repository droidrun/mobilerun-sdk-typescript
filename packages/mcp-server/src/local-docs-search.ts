...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "response": "{ id: string; status: 'queued' | 'created' | 'running' | 'cancelling' | 'paused' | 'completed' | 'failed' | 'cancelled'; streamUrl?: string; }",
  ...
  },
  {
    ...
    "description": "Create and dispatch a new agent task, returning an SSE stream of task events. Cancels the task if the client disconnects.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "tasks run_streamed",
        "example": "mobilerun-cloud tasks run-streamed \\\n  --api-key 'My API Key' \\\n  --device-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --task x"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/tasks/stream \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"deviceId\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"task\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "tasks stop",
        "example": "mobilerun-cloud tasks stop \\\n  --api-key 'My API Key' \\\n  --task-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/tasks/$TASK_ID/cancel \\\n    -X POST \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "tasks attach",
        "example": "mobilerun-cloud tasks attach \\\n  --api-key 'My API Key' \\\n  --task-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/tasks/$TASK_ID/attach \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ status: 'queued' | 'created' | 'running' | 'cancelling' | 'paused' | 'completed' | 'failed' | 'cancelled'; lastResponse?: object; message?: string; output?: object; steps?: number; succeeded?: boolean; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "tasks get_status",
        "example": "mobilerun-cloud tasks get-status \\\n  --api-key 'My API Key' \\\n  --task-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/tasks/$TASK_ID/status \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "tasks get_trajectory",
        "example": "mobilerun-cloud tasks get-trajectory \\\n  --api-key 'My API Key' \\\n  --task-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/tasks/$TASK_ID/trajectory \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ task: { deviceId: string; llmModel: string; task: string; userId: string; id?: string; agentId?: number; apps?: string[]; cancelRequestedAt?: string; claimedAt?: string; continueOnFailure?: boolean; createdAt?: string; credentials?: package_credentials[]; dispatchedAt?: string; displayId?: number; executionTimeout?: number; files?: string[]; finishedAt?: string; maxSteps?: number; memoryNamespace?: string; message?: string; output?: object; outputSchema?: object; reasoning?: boolean; status?: task_status; stealth?: boolean; steps?: number; streamUrl?: string; subagentModel?: string; succeeded?: boolean; temperature?: number; tmpDevice?: boolean; trajectory?: object[]; updatedAt?: string; vision?: boolean; vpnCountry?: 'US' | 'BR' | 'FR' | 'DE' | 'IN' | 'JP' | 'KR' | 'ZA'; }; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "tasks retrieve",
        "example": "mobilerun-cloud tasks retrieve \\\n  --api-key 'My API Key' \\\n  --task-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/tasks/$TASK_ID \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Send a message to a running agent task. The message ID is delivered via SSE (UserMessageEvent with action=queued).",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "tasks send_message",
        "example": "mobilerun-cloud tasks send-message \\\n  --api-key 'My API Key' \\\n  --task-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --message x"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/tasks/$TASK_ID/message \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"message\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud tasks:screenshots list \\\n  --api-key 'My API Key' \\\n  --task-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/tasks/$TASK_ID/screenshots \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud tasks:screenshots retrieve \\\n  --api-key 'My API Key' \\\n  --task-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --index 0"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/tasks/$TASK_ID/screenshots/$INDEX \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud tasks:ui-states list \\\n  --api-key 'My API Key' \\\n  --task-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/tasks/$TASK_ID/ui_states \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud tasks:ui-states retrieve \\\n  --api-key 'My API Key' \\\n  --task-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --index 0"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/tasks/$TASK_ID/ui_states/$INDEX \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: number; description: string; icon: string; llmModel: string; maxSteps: number; name: string; reasoning: boolean; subagentModel: string; vision: boolean; }[]",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/agents \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ data: { host: string; name: string; password: string; port: number; protocol: 'socks5'; proxyId: string; user: string; } | { config: string; name: string; protocol: 'wireguard'; proxyId: string; }[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/proxies \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ data: { host: string; name: string; password: string; port: number; protocol: 'socks5'; proxyId: string; user: string; } | { config: string; name: string; protocol: 'wireguard'; proxyId: string; }; message: string; success: true; }",
    "perLanguage": {
      "typescript": {
      ...
      "cli": {
        "method": "proxies create",
        "example": "mobilerun-cloud proxies create \\\n  --api-key 'My API Key' \\\n  --host x \\\n  --name xxx \\\n  --password x \\\n  --port 1 \\\n  --protocol socks5 \\\n  --user x \\\n  --config x"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/proxies \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"host\": \"x\",\n          \"name\": \"xxx\",\n          \"password\": \"x\",\n          \"port\": 1,\n          \"protocol\": \"socks5\",\n          \"user\": \"x\"\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "proxies retrieve",
        "example": "mobilerun-cloud proxies retrieve \\\n  --api-key 'My API Key' \\\n  --proxy-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/proxies/$PROXY_ID \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "proxies update",
        "example": "mobilerun-cloud proxies update \\\n  --api-key 'My API Key' \\\n  --proxy-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --host x \\\n  --name xxx \\\n  --password x \\\n  --port 1 \\\n  --protocol socks5 \\\n  --user x \\\n  --config x"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/proxies/$PROXY_ID \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"host\": \"x\",\n          \"name\": \"xxx\",\n          \"password\": \"x\",\n          \"port\": 1,\n          \"protocol\": \"socks5\",\n          \"user\": \"x\"\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "proxies delete",
        "example": "mobilerun-cloud proxies delete \\\n  --api-key 'My API Key' \\\n  --proxy-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/proxies/$PROXY_ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
  ...
  },
  {
    ...
    "response": "{ id: number; company: string; country: string; country_code: string; country_iso: string; created_at: string; detail_url: string; gsm_bands: string; lte_bands: string; mcc: string; mnc: string; mobile_prefix: string; nsn_size: string; number_format: string; operator: string; protocols: string; umts_bands: string; website: string; $schema?: string; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "carriers create",
        "example": "mobilerun-cloud carriers create \\\n  --country x \\\n  --mcc x \\\n  --mnc x \\\n  --operator x"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/carriers \\\n    -H 'Content-Type: application/json' \\\n    -d '{\n          \"country\": \"x\",\n          \"mcc\": \"x\",\n          \"mnc\": \"x\",\n          \"operator\": \"x\"\n        }'"
      }
  ...
  },
  {
    ...
    "response": "{ items: { id: string; createdAt: string; name: string; spec: device_spec; updatedAt: string; userId: string; $schema?: string; }[]; pagination: { hasNext: boolean; hasPrev: boolean; page: number; pages: number; pageSize: number; total: number; }; $schema?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/profiles \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; createdAt: string; name: string; spec: { $schema?: string; apps?: string[]; carrier?: device_carrier; files?: string[]; identifiers?: device_identifiers; name?: string; proxy?: object; }; updatedAt: string; userId: string; $schema?: string; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "profiles create",
        "example": "mobilerun-cloud profiles create \\\n  --api-key 'My API Key' \\\n  --name x \\\n  --spec '{}'"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/profiles \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"name\": \"x\",\n          \"spec\": {}\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "profiles retrieve",
        "example": "mobilerun-cloud profiles retrieve \\\n  --api-key 'My API Key' \\\n  --profile-id profileId"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/profiles/$PROFILE_ID \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "profiles update",
        "example": "mobilerun-cloud profiles update \\\n  --api-key 'My API Key' \\\n  --profile-id profileId \\\n  --name x \\\n  --spec '{}'"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/profiles/$PROFILE_ID \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"name\": \"x\",\n          \"spec\": {}\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/wait \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ items: { id: string; activeTaskId: string; assignedAt: string; createdAt: string; name: string; state: string; stateMessage: string; streamUrl: string; taskCount: number; terminatesAt: string; type: string; updatedAt: string; $schema?: string; providerId?: string; streamToken?: string; userId?: string; }[]; pagination: { hasNext: boolean; hasPrev: boolean; page: number; pages: number; pageSize: number; total: number; }; $schema?: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/count \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "devices set_name",
        "example": "mobilerun-cloud devices set-name \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --name x"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/name \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"name\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/time \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:time timezone \\\n  --api-key 'My API Key' \\\n  --device-id deviceId"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/timezone \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:time set-timezone \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --timezone timezone"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/timezone \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"timezone\": \"timezone\"\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:profile update \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --profile-id profileId"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/profile \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"profileId\": \"profileId\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ files: { extendedAttributes: boolean; group: string; hardLinks: number; modifiedAt: string; name: string; owner: string; permissions: object; size: number; type: string; symlinkTarget?: string; }[]; path: string; total: number; $schema?: string; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "files list",
        "example": "mobilerun-cloud devices:files list \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --path path"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/files \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "files upload",
        "example": "mobilerun-cloud devices:files upload \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --path path \\\n  --file 'Example data'"
      },
      "http": {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "files delete",
        "example": "mobilerun-cloud devices:files delete \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --path path"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/files \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:files download \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --path path"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/files/download \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "markdown": "## connect\n\n`client.devices.proxy.connect(deviceId: string, host?: string, name?: string, password?: string, port?: number, smartIp?: boolean, socks5?: { host: string; port: number; password?: string; user?: string; }, user?: string, wireguard?: string, X-Device-Display-ID?: number): void`\n\n**post** `/devices/{deviceId}/proxy`\n\nConnect proxy\n\n### Parameters\n\n- `deviceId: string`\n\n- `host?: string`\n\n- `name?: string`\n  Proxy name (used for wireguard tunnel name)\n\n- `password?: string`\n\n- `port?: number`\n\n- `smartIp?: boolean`\n\n- `socks5?: { host: string; port: number; password?: string; user?: string; }`\n  SOCKS5 proxy configuration (required for socks5).\n  - `host: string`\n  - `port: number`\n  - `password?: string`\n  - `user?: string`\n\n- `user?: string`\n\n- `wireguard?: string`\n  WireGuard tunnel configuration file content (required for wireguard).\n\n- `X-Device-Display-ID?: number`\n\n### Example\n\n```typescript\nimport Mobilerun from '@mobilerun/sdk';\n\nconst client = new Mobilerun();\n\nawait client.devices.proxy.connect('deviceId')\n```",
    "perLanguage": {
      "typescript": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:proxy connect \\\n  --api-key 'My API Key' \\\n  --device-id deviceId"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/proxy \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "proxy status",
        "example": "mobilerun-cloud devices:proxy status \\\n  --api-key 'My API Key' \\\n  --device-id deviceId"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/proxy \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:proxy disconnect \\\n  --api-key 'My API Key' \\\n  --device-id deviceId"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/proxy \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "location get",
        "example": "mobilerun-cloud devices:location get \\\n  --api-key 'My API Key' \\\n  --device-id deviceId"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/location \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "location set",
        "example": "mobilerun-cloud devices:location set \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --latitude 0 \\\n  --longitude 0"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/location \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"latitude\": 0,\n          \"longitude\": 0\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "actions tap",
        "example": "mobilerun-cloud devices:actions tap \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --x 0 \\\n  --y 0"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/tap \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"x\": 0,\n          \"y\": 0\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:actions swipe \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --duration 10 \\\n  --end-x 0 \\\n  --end-y 0 \\\n  --start-x 0 \\\n  --start-y 0"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/swipe \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"duration\": 10,\n          \"endX\": 0,\n          \"endY\": 0,\n          \"startX\": 0,\n          \"startY\": 0\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:actions global \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --action 0"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/global \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"action\": 0\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:actions set-overlay-visible \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --visible"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/overlay \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"visible\": true\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:actions overlay-visible \\\n  --api-key 'My API Key' \\\n  --device-id deviceId"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/overlay \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:state screenshot \\\n  --api-key 'My API Key' \\\n  --device-id deviceId"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/screenshot \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/ui-state \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "apps install",
        "example": "mobilerun-cloud devices:apps install \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --package-name packageName"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/apps \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"packageName\": \"packageName\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ isSystemApp: boolean; label: string; packageName: string; versionCode: number; versionName: string; }[]",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "apps start",
        "example": "mobilerun-cloud devices:apps start \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --package-name packageName"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/apps/$PACKAGE_NAME \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "apps delete",
        "example": "mobilerun-cloud devices:apps delete \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --package-name packageName"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/apps/$PACKAGE_NAME \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "apps update",
        "example": "mobilerun-cloud devices:apps update \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --package-name packageName"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/apps/$PACKAGE_NAME \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{}'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:packages list \\\n  --api-key 'My API Key' \\\n  --device-id deviceId"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/packages \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:keyboard write \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --text text"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/keyboard \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"text\": \"text\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:keyboard clear \\\n  --api-key 'My API Key' \\\n  --device-id deviceId"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/keyboard \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "keyboard key",
        "example": "mobilerun-cloud devices:keyboard key \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --key 0"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/keyboard \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"key\": 0\n        }'"
      }
  ...
  },
  {
    ...
    "response": "{ items: { createdAt: string; taskId: string; updatedAt: string; }[]; pagination: { hasNext: boolean; hasPrev: boolean; page: number; pages: number; pageSize: number; total: number; }; $schema?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/tasks \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ carrier: string; displayName: string; iccid: string; isEmbedded: boolean; slot: number; subId: number; type: string; $schema?: string; }[]",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/esim \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud devices:esim activate \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --enable \\\n  --matching-id matchingId \\\n  --sm-dp-addr smDpAddr"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/esim \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"enable\": true,\n          \"matchingId\": \"matchingId\",\n          \"smDpAddr\": \"smDpAddr\"\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "esim enable",
        "example": "mobilerun-cloud devices:esim enable \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --sub-id 0"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/esim \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"subId\": 0\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "esim remove",
        "example": "mobilerun-cloud devices:esim remove \\\n  --api-key 'My API Key' \\\n  --device-id deviceId \\\n  --sub-id 0"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/devices/$DEVICE_ID/esim \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
  ...
  },
  {
    ...
    "response": "{ count: { availableCount: number; queuedCount: number; storeCount: number; totalCount: number; uploadCount: number; }; items: { id: string; categoryName: string; country: string; createdAt: string; description: string; developerName: string; displayName: string; expectedFiles: string | number | boolean | object | object[]; iconURL: string; packageName: string; privacyPolicyUrl: string; queuedAt: string; ratingCount: number; ratingScore: string; sizeBytes: number; source: 'uploaded' | 'store'; status: 'queued' | 'available' | 'failed'; stealthTier: 'tier1' | 'tier2' | 'tier3'; targetSdk: number; type: 'android' | 'ios'; updatedAt: string; userId: string; versionCode: number; versionName: string; }[]; pagination: { hasNext: boolean; hasPrev: boolean; page: number; pages: number; pageSize: number; total: number; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/apps \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ items: { credentialName: string; fields: object[]; packageName: string; secretPath: string; userId: string; }[]; pagination: { hasNext: boolean; hasPrev: boolean; page: number; pages: number; pageSize: number; total: number; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/credentials \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud credentials:packages create \\\n  --api-key 'My API Key' \\\n  --package-name packageName"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/credentials/packages \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"packageName\": \"packageName\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ data: { credentialName: string; fields: object[]; packageName: string; secretPath: string; userId: string; }[]; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "packages list",
        "example": "mobilerun-cloud credentials:packages list \\\n  --api-key 'My API Key' \\\n  --package-name packageName"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/credentials/packages/$PACKAGE_NAME \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ data: { credentialName: string; fields: object[]; packageName: string; secretPath: string; userId: string; }; message: string; success: true; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud credentials:packages:credentials create \\\n  --api-key 'My API Key' \\\n  --package-name packageName \\\n  --credential-name 26f1kl_-n-71 \\\n  --field '{fieldType: email, value: x}'"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/credentials/packages/$PACKAGE_NAME \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"credentialName\": \"26f1kl_-n-71\",\n          \"fields\": [\n            {\n              \"fieldType\": \"email\",\n              \"value\": \"x\"\n            }\n          ]\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud credentials:packages:credentials retrieve \\\n  --api-key 'My API Key' \\\n  --package-name packageName \\\n  --credential-name credentialName"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/credentials/packages/$PACKAGE_NAME/credentials/$CREDENTIAL_NAME \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud credentials:packages:credentials delete \\\n  --api-key 'My API Key' \\\n  --package-name packageName \\\n  --credential-name credentialName"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/credentials/packages/$PACKAGE_NAME/credentials/$CREDENTIAL_NAME \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud credentials:packages:credentials:fields delete \\\n  --api-key 'My API Key' \\\n  --package-name packageName \\\n  --credential-name credentialName \\\n  --field-type email"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/credentials/packages/$PACKAGE_NAME/credentials/$CREDENTIAL_NAME/fields/$FIELD_TYPE \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud credentials:packages:credentials:fields update \\\n  --api-key 'My API Key' \\\n  --package-name packageName \\\n  --credential-name credentialName \\\n  --field-type email \\\n  --value x"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/credentials/packages/$PACKAGE_NAME/credentials/$CREDENTIAL_NAME/fields/$FIELD_TYPE \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"value\": \"x\"\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "mobilerun-cloud credentials:packages:credentials:fields create \\\n  --api-key 'My API Key' \\\n  --package-name packageName \\\n  --credential-name credentialName \\\n  --field-type email \\\n  --value x"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/credentials/packages/$PACKAGE_NAME/credentials/$CREDENTIAL_NAME/fields \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"fieldType\": \"email\",\n          \"value\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/hooks \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/hooks/perform \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"foo\": \"bar\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/hooks/sample \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "hooks subscribe",
        "example": "mobilerun-cloud hooks subscribe \\\n  --api-key 'My API Key' \\\n  --target-url https://example.com"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/hooks/subscribe \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{\n          \"targetUrl\": \"https://example.com\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "hooks update",
        "example": "mobilerun-cloud hooks update \\\n  --api-key 'My API Key' \\\n  --hook-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/hooks/$HOOK_ID/edit \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "httpMethod": "post",
    "summary": "Unsubscribe",
    "description": "Unsubscribe a previously created subscription by id.\n\nPermanently deletes the subscription if it belongs to the user.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "hooks unsubscribe",
        "example": "mobilerun-cloud hooks unsubscribe \\\n  --api-key 'My API Key' \\\n  --hook-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/hooks/$HOOK_ID/unsubscribe \\\n    -X POST \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ service: 'zapier' | 'n8n' | 'make' | 'internal' | 'other'; url: string; userId: string; id?: string; createdAt?: string; events?: 'queued' | 'created' | 'running' | 'cancelling' | 'paused' | 'completed' | 'failed' | 'cancelled'[]; state?: 'active' | 'disabled' | 'deleted'; updatedAt?: string; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "hooks retrieve",
        "example": "mobilerun-cloud hooks retrieve \\\n  --api-key 'My API Key' \\\n  --hook-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/hooks/$HOOK_ID \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ data?: { id?: string; created?: number; object?: string; owned_by?: string; }[]; object?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.mobilerun.ai/v1/models \\\n    -H \"Authorization: Bearer $MOBILERUN_CLOUD_API_KEY\""
      }
    }
  }
];
