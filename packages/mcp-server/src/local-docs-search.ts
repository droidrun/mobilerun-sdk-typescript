...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ items: { id: string; deviceId: string; displayId: number; llmModel: string; status: 'queued' | 'created' | 'running' | 'cancelling' | 'paused' | 'completed' | 'failed' | 'cancelled'; task: string; tmpDevice: boolean; userId: string; agentId?: number; apps?: string[]; cancelRequestedAt?: string; claimedAt?: string; continueOnFailure?: boolean; createdAt?: string; credentials?: object[]; creditsUsed?: number; dispatchedAt?: string; executionTimeout?: number; files?: string[]; finishedAt?: string; maxSteps?: number; memoryNamespace?: string; message?: string; output?: object; outputSchema?: object; reasoning?: boolean; stealth?: boolean; steps?: number; streamUrl?: string; subagentModel?: string; succeeded?: boolean; temperature?: number; updatedAt?: string; vision?: boolean; vpnCountry?: 'US' | 'BR' | 'FR' | 'DE' | 'IN' | 'JP' | 'KR' | 'ZA'; }[]; pagination: { hasNext: boolean; hasPrev: boolean; page: number; pages: number; pageSize: number; total: number; }; }",
    markdown:
      "## list\n\n`client.tasks.list(orderBy?: 'id' | 'createdAt' | 'finishedAt' | 'status', orderByDirection?: 'asc' | 'desc', page?: number, pageSize?: number, query?: string, status?: 'queued' | 'created' | 'running' | 'cancelling' | 'paused' | 'completed' | 'failed' | 'cancelled'): { items: object[]; pagination: pagination_meta; }`\n\n**get** `/tasks`\n\nList tasks with optional filtering, sorting, and pagination.\n\n### Parameters\n\n- `orderBy?: 'id' | 'createdAt' | 'finishedAt' | 'status'`\n\n- `orderByDirection?: 'asc' | 'desc'`\n\n- `page?: number`\n\n- `pageSize?: number`\n\n- `query?: string`\n  Search in task description.\n\n- `status?: 'queued' | 'created' | 'running' | 'cancelling' | 'paused' | 'completed' | 'failed' | 'cancelled'`\n\n### Returns\n\n- `{ items: { id: string; deviceId: string; displayId: number; llmModel: string; status: 'queued' | 'created' | 'running' | 'cancelling' | 'paused' | 'completed' | 'failed' | 'cancelled'; task: string; tmpDevice: boolean; userId: string; agentId?: number; apps?: string[]; cancelRequestedAt?: string; claimedAt?: string; continueOnFailure?: boolean; createdAt?: string; credentials?: object[]; creditsUsed?: number; dispatchedAt?: string; executionTimeout?: number; files?: string[]; finishedAt?: string; maxSteps?: number; memoryNamespace?: string; message?: string; output?: object; outputSchema?: object; reasoning?: boolean; stealth?: boolean; steps?: number; streamUrl?: string; subagentModel?: string; succeeded?: boolean; temperature?: number; updatedAt?: string; vision?: boolean; vpnCountry?: 'US' | 'BR' | 'FR' | 'DE' | 'IN' | 'JP' | 'KR' | 'ZA'; }[]; pagination: { hasNext: boolean; hasPrev: boolean; page: number; pages: number; pageSize: number; total: number; }; }`\n\n  - `items: { id: string; deviceId: string; displayId: number; llmModel: string; status: 'queued' | 'created' | 'running' | 'cancelling' | 'paused' | 'completed' | 'failed' | 'cancelled'; task: string; tmpDevice: boolean; userId: string; agentId?: number; apps?: string[]; cancelRequestedAt?: string; claimedAt?: string; continueOnFailure?: boolean; createdAt?: string; credentials?: { credentialNames: string[]; packageName: string; }[]; creditsUsed?: number; dispatchedAt?: string; executionTimeout?: number; files?: string[]; finishedAt?: string; maxSteps?: number; memoryNamespace?: string; message?: string; output?: object; outputSchema?: object; reasoning?: boolean; stealth?: boolean; steps?: number; streamUrl?: string; subagentModel?: string; succeeded?: boolean; temperature?: number; updatedAt?: string; vision?: boolean; vpnCountry?: 'US' | 'BR' | 'FR' | 'DE' | 'IN' | 'JP' | 'KR' | 'ZA'; }[]`\n  - `pagination: { hasNext: boolean; hasPrev: boolean; page: number; pages: number; pageSize: number; total: number; }`\n\n### Example\n\n```typescript\nimport Mobilerun from '@mobilerun/sdk';\n\nconst client = new Mobilerun();\n\nconst tasks = await client.tasks.list();\n\nconsole.log(tasks);\n```",
    perLanguage: {
      typescript: {
