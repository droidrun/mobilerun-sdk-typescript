...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Mobilerun): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Mobilerun): Logger {
