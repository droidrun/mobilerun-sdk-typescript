...
export class Numbers extends APIResource {
   ...
   * ```
   */
  create(params: NumberCreateParams | null | undefined = {}, options?: RequestOptions): APIPromise<NumberCreateResponse> {
    const { 'Idempotency-Key': idempotencyKey, ...body } = params ?? {}
    return this._client.post('/numbers/phones', { body, ...options, headers: buildHeaders([{...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined)}, options?.headers]) });
  }
   ...
   * ```
   */
  list(query: NumberListParams | null | undefined = {}, options?: RequestOptions): APIPromise<NumberListResponse> {
