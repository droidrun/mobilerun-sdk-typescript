...
export interface ElementNode {
  ...
  boundsInParent: ElementNode.BoundsInParent;

  boundsInScreen: ElementNode.BoundsInScreen;

  childCount: number;

  children: Array<ElementNode> | null;

  className: string;

  collectionInfo: ElementNode.CollectionInfo;

  collectionItemInfo: ElementNode.CollectionItemInfo;
  ...
  rangeInfo: ElementNode.RangeInfo;
