...
export class DeepLink extends APIResource {
  ...
  executeDeepLink(
    deviceID: string,
    params: DeepLinkExecuteDeepLinkParams,
    options?: RequestOptions,
  ): APIPromise<void> {
    const { 'X-Device-Display-ID': xDeviceDisplayID, ...body } = params;
    return this._client.post(path`/devices/${deviceID}/apps/open-deep-link`, {
      body,
      ...options,
...
export declare namespace DeepLink {
  export { type DeepLinkExecuteDeepLinkParams as DeepLinkExecuteDeepLinkParams };
}
