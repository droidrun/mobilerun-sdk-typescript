...
export class Esims extends APIResource {
   ...
   */
  create(
    body: EsimCreateParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<EsimCreateResponse> {
  ...
  update(
    id: string,
    body: EsimUpdateParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<EsimUpdateResponse> {
   ...
   */
  list(
    query: EsimListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<EsimListResponse> {
  ...
  delete(id: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/numbers/esims/${id}`, {
      ...options,
   ...
   */
  import(
    body: EsimImportParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<EsimImportResponse> {
  ...
  install(
    id: string,
    body: EsimInstallParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<EsimInstallResponse> {
...
export interface EsimImportResponse {
  data:
    | EsimImportResponse.PublicEsim
    | EsimImportResponse.EsimAwaitingPaymentResponse
    | EsimImportResponse.EsimImportInstallDispatchFailedResponse;
}
